...
public:
    QAction *actionQuit;
    QAction *actionEditAddress;
    QAction *actionEditLate;
    ...
    QMenu *menuBlackboard_Address;
    QMenu *menuLate_Threshold;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionEditAddress = new QAction(MainWindow);
        actionEditAddress->setObjectName(QString::fromUtf8("actionEditAddress"));
        actionEditLate = new QAction(MainWindow);
        actionEditLate->setObjectName(QString::fromUtf8("actionEditLate"));
        ...
        menuBlackboard_Address = new QMenu(menuBBAttendanceTracker);
        menuBlackboard_Address->setObjectName(QString::fromUtf8("menuBlackboard_Address"));
        menuLate_Threshold = new QMenu(menuBBAttendanceTracker);
        menuLate_Threshold->setObjectName(QString::fromUtf8("menuLate_Threshold"));
        ...
        menuBBAttendanceTracker->addAction(menuBlackboard_Address->menuAction());
        menuBBAttendanceTracker->addAction(menuLate_Threshold->menuAction());
        menuBBAttendanceTracker->addSeparator();
        menuBBAttendanceTracker->addAction(actionQuit);
        menuBlackboard_Address->addAction(actionEditAddress);
        menuLate_Threshold->addAction(actionEditLate);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuBlackboard_Address->setTitle(QCoreApplication::translate("MainWindow", "Blackboard Address", nullptr));
        menuLate_Threshold->setTitle(QCoreApplication::translate("MainWindow", "Late Threshold", nullptr));
    } // retranslateUi
